...
#' @examples
#'
#' sunburst_trelliscope(data = dat, facet = "state_company", quant_variable = "amount_award")
#'
sunburst_trelliscope <- function(data, facet, quant_variable, title = "Sunburst", path = "~Sunburst"){
